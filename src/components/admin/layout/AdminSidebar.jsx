...
import { LayoutDashboard, ShoppingBag, Users, Tag, Mail, PackagePlus, LogOut } from "lucide-react";
    ...
    >
      ...
      <nav className="flex-1 flex flex-col gap-1">
        {visibleLinks.map(({ label, href, icon: Icon }) => {
          // "/admin" (Overview) ke liye EXACT match chahiye, warna har sub-route match kar jata
          const isActive =
            href === "/admin"
              ? pathname === "/admin"
